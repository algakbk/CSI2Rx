...
HD_PWD='/home/alga/workspace/github/CSI2Rx/project/IPcore/managed_ip_project/managed_ip_project.runs/system_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_clk.tcl
