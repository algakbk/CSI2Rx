...
HD_PWD='/home/alga/workspace/github/CSI2Rx_demo/project/ov4689/ov4689.runs/camera_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_pll.tcl
