...
HD_PWD='/home/alga/workspace/github/CSI2Rx_demo/project/ov4689/ov4689.runs/output_line_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log output_line_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source output_line_buffer.tcl
