...
HD_PWD='/home/alga/workspace/github/CSI2Rx_demo/project/ov4689/ov4689.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ov13850_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ov13850_demo.tcl
