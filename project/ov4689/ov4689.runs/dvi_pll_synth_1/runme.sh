...
HD_PWD='/home/baktiiar/workspace/github/CSI2Rx/project/ov4689/ov4689.runs/dvi_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dvi_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dvi_pll.tcl
