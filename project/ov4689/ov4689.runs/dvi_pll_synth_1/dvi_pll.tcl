...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.runs/dvi_pll_synth_1 -new_name dvi_pll -ip [get_ips dvi_pll]]
...
if { [catch {
  file copy -force /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.runs/dvi_pll_synth_1/dvi_pll.dcp /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.runs/dvi_pll_synth_1/dvi_pll_stub.v /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.runs/dvi_pll_synth_1/dvi_pll_stub.vhdl /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.runs/dvi_pll_synth_1/dvi_pll_sim_netlist.v /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.runs/dvi_pll_synth_1/dvi_pll_sim_netlist.vhdl /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.ip_user_files/ip/dvi_pll]} {
  catch { 
    file copy -force /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_stub.v /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.ip_user_files/ip/dvi_pll
  }
}

if {[file isdir /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.ip_user_files/ip/dvi_pll]} {
  catch { 
    file copy -force /home/alga/workspace/github/CSI2Rx/project/IPcore/dvi_pll_1/dvi_pll_stub.vhdl /home/alga/workspace/github/CSI2Rx/project/ov4689/ov4689.ip_user_files/ip/dvi_pll
  }
}
