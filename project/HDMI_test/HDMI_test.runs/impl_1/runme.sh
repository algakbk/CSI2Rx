...
HD_PWD='/home/alga/workspace/github/CSI2Rx/project/HDMI_test/HDMI_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VHDL_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VHDL_test.tcl -notrace
