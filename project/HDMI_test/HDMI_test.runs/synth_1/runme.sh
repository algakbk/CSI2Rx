...
HD_PWD='/home/alga/workspace/github/CSI2Rx/project/HDMI_test/HDMI_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VHDL_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VHDL_test.tcl
